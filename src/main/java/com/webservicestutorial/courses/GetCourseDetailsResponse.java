...
@XmlRootElement(name = "GetCourseDetailsResponse", namespace = "http://someBookDetails.com/courses")
public class GetCourseDetailsResponse {

    @XmlElement(name = "CourseDetails", namespace = "http://someBookDetails.com/courses", required = true)
    ...
    public static class CourseDetails {
        ...
        @XmlElement(namespace = "http://someBookDetails.com/courses", required = true)
